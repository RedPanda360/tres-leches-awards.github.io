...
<head>
  ...
  <style>
    ...
    .category-header::after { content: "▼"; position: absolute; right: 0; top: 50%; transform: translateY(-50%); transition: transform 0.3s; font-size: 18px; }
...
const actors = [
  ...
  "Jesse Eisenberg — Now You See Me: Now You Don’t",
  ...
  "Josh Brolin — Weapons",
  "Jack Black — The Minecraft Movie",
  "Brad Pitt — F1",
...
const actresses = [
  ...
  "Meghann Fahy — Drop",
  "Kaithyn Santa Juana — Final Destination Bloodline",
  "Ella Rubin — Until Dawn",
...
const categoryDescriptions = {
  ...
  "Most Disappointing": "High expectations that didn’t deliver.",
  ...
  "Most Rewatchable": "The movie you’d watch again and again.",
...
function showResults() {
  ...
  resultsDiv.innerHTML = "<h2>🏆 Winners</h2><div class='cards'></div>";
